...
def render_binary():
    ...
    print("FILTER GRAPH SAME EDIT STRUCTURE", flush=True)
    fc = (
    ...
    print("MEXENDO COM FONTE", flush=True)
    if caption_esc:
        fc += (
    ...
    print("CONFIGURANDO FFMPEG", flush=True)
    ...
    print("COMECA SUBPROCESS", flush=True)
